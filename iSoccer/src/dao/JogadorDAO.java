...
public class JogadorDAO extends FuncionariosDAO{
	private int type;
	private int aptos;

	public JogadorDAO(String name, String email, String cpf, double salario, String telefone, int type, int aptos) {
